 ...
 * A contact is considered unique by comparing using {@code Person#isSamePerson(Person)}. As such, adding and updating of
 * persons uses Person#isSamePerson(Person) for equality so as to ensure that the contact being added or updated is
 * unique in terms of identity in the UniquePersonList. However, the removal of a contact uses Person#equals(Object) so
...
public class UniquePersonList implements Iterable<Person> {
    ...
    /**
     * Replaces the contact {@code target} in the list with {@code editedPerson}.
     * {@code target} must exist in the list.
     * The contact identity of {@code editedPerson} must not be the same as another existing contact in the list.
     */
